...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Навигация по цветам:";
			// 
			// label2
			// 
			this->label2->AutoSize = true;
			this->label2->Location = System::Drawing::Point(593, 52);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(202, 234);
